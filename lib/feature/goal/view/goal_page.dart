              ...
              child: FloatingActionButton.extended(
                ...
                onPressed: () => context.pushNamed(
                  ...
                  extra: GoalFormArgs(
                    ...
                    preSelectedCategory: GoalCategory.personalGrowth,
                  ),
                ),
                icon: const Icon(Icons.add),
                label: Text(l10n.new_goal),
              ),
            ),
          ),
          body: SafeArea(
            ...
            Row(
              children: [
                ...
                TextButton(
                  ...
                  child: Text(hasReflection ? l10n.edit_action : l10n.reflect),
                ),
              ],
            ),
            const SizedBox(height: Spacing.sm),
              ...
              if (reflection!.reward.isNotEmpty) ...[
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        l10n.reward_label(reflection!.reward),
                        style: context.textTheme.bodyMedium?.copyWith(
                          color: Colors.white,
                        ),
                      ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              l10n.add_category_goal(category.labelOf(l10n).toLowerCase()),
              style: context.textTheme.bodyMedium?.copyWith(
                color: Colors.white70,
              ),
            ),
          ...
          child: Row(
            children: [
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: goal.isCompleted
                        ? AppColors.mintPrimary.withValues(alpha: 0.7)
                        : Colors.transparent,
                  ),
                  ...
                  children: [
                    ...
                    if (goal.dueDate != null)
                      Padding(
                        ...
                        child: Text(
                          l10n.due_label(_formatDate(goal.dueDate!)),
              ...
              IconButton(
                ...
                onPressed: () => _showDeleteConfirmation(context, goal, l10n),
                icon: const Icon(
