...
final pinkTheme = ThemeData(
  ...
  chipTheme: ChipThemeData(
    ...
    backgroundColor: colorSchemePinkExt.primary,
  ...
  dividerTheme: DividerThemeData(
    thickness: 0.5,
    color: colorSchemePinkExt.lightShadeGrey20,
  ),
  textTheme: Typography.material2021().white
      ...
      .apply(
        bodyColor: colorSchemePinkExt.primaryText,
        displayColor: colorSchemePinkExt.primaryText,
        fontFamily: Fonts.en,
        fontFamilyFallback: [Fonts.kh, Fonts.en],
      ),
  colorScheme: colorSchemePink,
  primaryColor: colorSchemePinkExt.primary,
  ...
  // primaryColorDark: colorSchemePinkExt.primary900,
  // primaryColorLight: colorSchemePinkExt.primary400,
  ...
  expansionTileTheme: ExpansionTileThemeData(
    ...
    iconColor: colorSchemePinkExt.primary,
    textColor: colorSchemePinkExt.primaryText,
    collapsedTextColor: colorSchemePinkExt.primaryText,
    collapsedIconColor: colorSchemePinkExt.primary,
  ),
  inputDecorationTheme: InputDecorationTheme(
    hintStyle: TextStyle(
      fontSize: 14,
      fontWeight: FontWeight.w500,
      color: colorSchemePinkExt.lightShadeGrey50,
    ...
    focusedBorder: OutlineInputBorder(
      ...
      borderSide: BorderSide(width: 2, color: colorSchemePinkExt.primary),
    ),
    ...
    enabledBorder: OutlineInputBorder(
      borderSide: BorderSide(
        width: 0.5,
        color: colorSchemePinkExt.lightShadeGrey30,
      ),
      borderRadius: BorderRadius.circular(12),
    ),
  ...
  bottomNavigationBarTheme: BottomNavigationBarThemeData(
    ...
    elevation: 1,
    backgroundColor: colorSchemePinkExt.lightShadeGrey10,
    type: BottomNavigationBarType.fixed,
    selectedItemColor: AppColors.primary,
    unselectedItemColor: colorSchemePinkExt.darkShadeGrey80,
  ...
  iconButtonTheme: IconButtonThemeData(
    style: IconButton.styleFrom(
      ...
      iconSize: 20,
      backgroundColor: colorSchemePink.surface,
      foregroundColor: colorSchemePink.onSurface,
  ...
  appBarTheme: AppBarTheme(
    ...
    titleTextStyle: TextStyle(
      ...
      fontWeight: FontWeight.w600,
      fontFamilyFallback: const [Fonts.kh],
      color: colorSchemePink.onSurface,
      fontFamily: Fonts.en,
    ),
    iconTheme: IconThemeData(color: colorSchemePink.onSurface),
    elevation: 0,
    backgroundColor: colorSchemePinkExt.primary,
    actionsIconTheme: IconThemeData(size: 24, color: colorSchemePink.onSurface),
    centerTitle: true,
  ),
);
